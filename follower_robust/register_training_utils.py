...
def make_custom_encoder_context(cfg: Config, obs_space: ObsSpace) -> Encoder:
    """Factory function as required by the API."""
    return ResnetEncoder_context(cfg, obs_space)

def register_custom_model_context():
    global_model_factory().register_encoder_factory(make_custom_encoder_context)
